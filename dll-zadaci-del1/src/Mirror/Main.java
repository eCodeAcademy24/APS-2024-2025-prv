...
// Да се напише алгоритам која дадена двострано поврзана листа ќе ја модифицира со тоа
// што секој јазол ќе го спои со неговиот огледален.
// Огледални јазли се првиот и последниот, вториот и претпоследниот, итн...
//влез: 1 2 3 4 5
//излез: 1 5 2 4 3;
