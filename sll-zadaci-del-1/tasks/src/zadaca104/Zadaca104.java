...
public class Zadaca104 {
    ...
    public static int zadaca4(SLL<Integer> lista, int x) {
        SLLNode<Integer> iterator = lista.getFirst();
        SLLNode<Integer> lastOccurrence = null;
        ...
        while(iterator != null) {
            if (iterator.element.equals(x)) {
                lastOccurrence = iterator;
                lastOccurrencePosition = position;
            }
        ...
        lista.insertLast(x);
        lista.delete(lastOccurrence);
        System.out.println(lista);

        return lastOccurrencePosition;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(zadaca4(lista, x));
    }
}
