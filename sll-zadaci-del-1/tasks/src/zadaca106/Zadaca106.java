...
//   избрише сите елементи кои во data полето имаат непарен број. Како резултат
...
public class Zadaca106 {

    public static int zadaca6(SLL<Integer> lista, int x) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(zadaca6(lista, x));
    }
}
