...
public class Heroes {
//         Во една игра со карти се користат специјални карти, т.ш. за секоја карта се важни податоците за: id на херојот на картата
//        (int id), моќта на херојот (int power), како и бројот на напади кои тој може да ги направи (int numAttacks).
//
...
//        картите кои им се доделени. Во првата листа се чуваат картите доделени на првиот пријател,
//        а додека пак во втората се чуваат податоците за картите доделени на вториот пријател. И двајцата играчи на почеток
//        имаат точно 6 карти.
//
...
//        Внимавајте:
//
//        1. Даден е целосниот код на структурата којашто треба да се користи. Дадена е и тест класата Heroes.java,
//        со целосно имплементиран input и output. Потребно е да се менува само во рамки на
//        void startHeroesGame(SLL<Card> firstFriendCards, SLL<Card> secondFriendCards) функцијата.
//
//        2. Притоа, бришењето треба да биде имплементирано како бришење на цел јазол, а додавањето како додавање на цел јазол.
//        Промените (бришење/додавање елемент) не треба да се однесуваат на информациите во самите јазли туку во
//        промени на врските помеѓу јазлите.
//
//        3. Не смее да менувате во main функцијата !

// Input и Output примерите ги имате во heroes-inputs.txt
